...
const productData = {
  ...
  description: `Miazen-F2 | Ferrous Ascorbate & Folic Acid Syrup
Revitalize Your Energy, Support Your Growth.
Fuel your body with the essential nutrients it needs to thrive. Miazen-F2 is a premium nutritional supplement specifically formulated to bridge the gap in daily nutrition. By combining the metabolic power of Ferrous Ascorbate and Folic Acid, Miazen-F2 offers a comprehensive approach to daily wellness`,
  composition: [
    "Calamine BP: 15% w/v",
    "Zinc Oxide BP: 5% w/v",
    "Bentonite: 3% w/v",
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            >
              <Image 
                src={'/Gemini_Generated_Image_7lazde7lazde7laz.png'} 
