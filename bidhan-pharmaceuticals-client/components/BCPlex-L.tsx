...
const productData = {
  ...
  genericName: "Vitamin-B Complex with L-Lysine and Zinc",
  description: `BCPlex - L | Vitamin B-Complex with L-Lysine & Zinc
Revitalize Your Energy, Support Your Growth.
Fuel your body with the essential nutrients it needs to thrive. BCPlex - L is a premium nutritional supplement specifically formulated to bridge the gap in daily nutrition. By combining the metabolic power of B-Vitamins with the growth-promoting properties of L-Lysine and the immune-boosting strength of Zinc, BCPlex - L offers a comprehensive approach to daily wellness`,
  composition: [
    "Calamine BP: 15% w/v",
    "Zinc Oxide BP: 5% w/v",
    "Bentonite: 3% w/v",
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            >
              <Image 
                src={'/WhatsApp Image 2026-02-04 at 14.18.50.jpeg'} 
