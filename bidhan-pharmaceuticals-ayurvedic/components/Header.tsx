...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full backdrop-blur-lg border-b border-slate-200 bg-neutral-600/50 bg-gradient-to-r from-emerald-900 via-emerald-800 to-teal-700 h-24 w-full">
                    ...
                    <nav className="hidden lg:flex items-center gap-1">
                        {navLinks.map((link) => (
                            <Link
                                key={link.name}
                                href={link.href}
                                className="px-4 text-white text-md py-2 text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors rounded-full hover:bg-slate-50"
                            >
                                {link.name}
                            </Link>
                        ))}
                        ...
                        <Link
                            href="/contact-us"
                            className="ml-6 inline-flex items-center rounded-full bg-blue-600 px-6 py-2.5 text-sm font-semibold text-white shadow-lg hover:shadow-blue-400 hover:bg-blue-700 hover:shadow-blue-300 transition-all active:scale-95"
                        >
                            Get in Touch
                        </Link>
                    </nav>
