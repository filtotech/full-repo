...
export default function Footer() {
	return (
		<footer className="bg-gradient-to-r from-emerald-900 via-emerald-800 to-teal-700 text-slate-300">
			{/* Top Section */}
			<div className="mx-auto max-w-7xl px-6 py-16">
				<div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
					{/* Brand */}
					<div className="space-y-4 sm:flex sm:flex-row md:flex-col">
						<div className="flex flex-col items-center gap-3">
													<Image className="scale-200" quality={100} src={'/bidhan-ayurvedic-division.png'} width={150} height={90} alt="./bidhan pharmacetuicals logo"/>
